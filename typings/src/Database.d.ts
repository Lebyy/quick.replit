...
declare class Database {
   ...
   */
    delete(key: string, ops?: object): Promise<boolean>;
    /**
   ...
   */
    exists(key: string, ops?: object): Promise<boolean>;
    /**
   ...
   */
    has(key: string, ops?: object): Promise<boolean>;
    /**
   ...
   */
    typeof(key: string, ops?: object): Promise<"string" | "number" | "bigint" | "boolean" | "symbol" | "undefined" | "object" | "function" | "array">;
    /**
   ...
   */
    listall(prefix?: string, ops?: object): Promise<any[]>;
    /**
   ...
   */
    clear(ops?: object): Promise<boolean>;
    /**
   ...
   */
    deleteAll(ops?: object): Promise<boolean>;
    /**
   ...
   */
    exportToQuickDB(quickdb: any): Promise<any[]>;
    /**
   ...
   */
    exportToQuickMongo(quickmongo: any): Promise<any[]>;
    /**
   * Write latency
   * @ignore
   * @private
